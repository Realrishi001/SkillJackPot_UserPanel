        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-8 rounded-3xl shadow-2xl max-w-md w-full transform transition-all duration-300 hover:scale-105">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex w-full">
              <button
                type="submit"
                className={`px-6 py-3 w-full cursor-pointer rounded-lg font-semibold bg-gradient-to-r from-purple-600 to-pink-600 text-white hover:from-purple-700 hover:to-pink-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl ${loading ? 'opacity-60 pointer-events-none' : ''}`}
                disabled={loading}
              >
